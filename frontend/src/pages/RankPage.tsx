...
const SIZE_KEY = 'arbiter.setSize'
const LEGACY_SIZE_KEY = 'curator.setSize'
...
export default function RankPage({ ctx }: { ctx: ContestContext }) {
  ...
  const [size, setSize] = useState(() => {
    const stored = Number(localStorage.getItem(SIZE_KEY) ?? localStorage.getItem(LEGACY_SIZE_KEY))
