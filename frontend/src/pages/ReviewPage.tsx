  ...
  return (
    <div className="page">
      <div className="page-head">
        ...
        <p className="muted">
          {ctx.canEdit
            ? 'These titles score outside the tier you filed them under. Look at them, ' +
              'then accept the implied tier, pick another, or keep what you had.'
            : 'These titles score outside the tier they were filed under.'}
        </p>
      </div>
      ...
      <ul className="review-list">
        {visible.map((item) => (
          <li key={item.id} className={`review-row${item.provisional ? ' is-provisional' : ''}`}>
            ...
            {ctx.canEdit && <div className="review-actions">
