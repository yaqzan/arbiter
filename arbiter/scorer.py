...
Ported from a ranking engine in another (private) project, which is the version
...
that corpus (975 items, ~1k comparisons) and carry over because the model is
...
`arbiter/media_types.py` owns the mapping — do not hardcode a type key in here.
